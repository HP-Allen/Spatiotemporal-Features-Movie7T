...
for subi = 1:image_dim(1)
    ...
    sFC_RestDay1(subi,:,:) = corr(squeeze(RestDay1_GM_NetworkLevel(subi,:,:))',squeeze(RestDay1_WM_NetworkLevel(subi,:,:))');
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/sFC_RestDay1_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/sFC_RestDay1_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/sFC_RestDay1','sFC_RestDay1');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/sFC_RestDay1_ave','sFC_RestDay1_ave');
