...
GM_dim = size(MovieDay1_GM_NetworkLevel);
WM_dim = size(MovieDay1_WM_NetworkLevel);
...
for subi = 1:GM_dim(1)
    ...
    for step = 1:GM_dim(3)-30+1
        dFC_series(subi,:,:,step) = corr(squeeze(MovieDay1_GM_NetworkLevel(subi,:,step:step+30-1))', squeeze(MovieDay1_WM_NetworkLevel(subi,:,step:step+30-1))');
    end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/dFC_MovieDay1_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/dFC_MovieDay1_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/dFC_MovieDay1','dFC_MovieDay1');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/NetworkLevel/dFC_MovieDay1_ave','dFC_MovieDay1_ave');
