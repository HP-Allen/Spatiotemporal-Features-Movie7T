...
% dFC_MovieDay2: subjects x GM x WM
for subi = 1:image_dim(1)
    tic
    disp(['Now running sub' num2str(subi) '......']);
    
    for step = 1:image_dim(3)-30+1
        dFC_series(subi,:,:,step) = corr(squeeze(MovieDay2_GM_ROILevel(subi,:,step:step+30-1))', squeeze(MovieDay2_WM_ROILevel(subi,:,step:step+30-1))');
    end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_MovieDay2_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_MovieDay2_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_MovieDay2','dFC_MovieDay2');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_MovieDay2_ave','dFC_MovieDay2_ave');
