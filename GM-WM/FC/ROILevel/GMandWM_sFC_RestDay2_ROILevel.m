...
for subi = 1:image_dim(1)
    ...
    sFC_RestDay2(subi,:,:) = corr(squeeze(RestDay2_GM_ROILevel(subi,:,:))',squeeze(RestDay2_WM_ROILevel(subi,:,:))');
...
Input = zeros(size(sFC_RestDay2_ave,1)+ex,size(sFC_RestDay2_ave,2)+ex);
Input = Input + NaN;
Input(1:200,1+ex:200+ex) = sFC_RestDay2_ave;
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/sFC_RestDay2_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/sFC_RestDay2_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/sFC_RestDay2','sFC_RestDay2');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/sFC_RestDay2_ave','sFC_RestDay2_ave');
