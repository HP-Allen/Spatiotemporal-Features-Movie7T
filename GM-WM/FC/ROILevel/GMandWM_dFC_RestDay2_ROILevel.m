...
for subi = 1:image_dim(1)
    ...
    for step = 1:image_dim(3)-30+1
        dFC_series(subi,:,:,step) = corr(squeeze(RestDay2_GM_ROILevel(subi,:,step:step+30-1))', squeeze(RestDay2_WM_ROILevel(subi,:,step:step+30-1))');
    end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_RestDay2_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_RestDay2_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_RestDay2','dFC_RestDay2');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/dFC_RestDay2_ave','dFC_RestDay2_ave');
