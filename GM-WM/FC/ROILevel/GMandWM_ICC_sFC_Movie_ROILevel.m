...
load('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/sFC_MovieDay1');
load('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/sFC_MovieDay2');
...
for roii = 1:dim(2)
    for roij = 1:dim(2)
        ...
        ICC_sFC_Movie_GMandWM(roii,roij) = r;
    end
end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/ICC_sFC_Movie_GMandWM.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/ICC_sFC_Movie_GMandWM.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/FC/ROILevel/ICC_sFC_Movie_GMandWM','ICC_sFC_Movie_GMandWM');
