...
image_dim_GM = size(RestDay1_GM_NetworkLevel);
image_dim_WM = size(RestDay1_WM_NetworkLevel);
...
for neti = 1:image_dim_GM(2)
    ...
    for netj = 1:image_dim_WM(2)
        ...
        for step = 1:image_dim_GM(3)-30+1
        	dISFC_series(:,:,neti,netj,step) = corr(squeeze(RestDay1_GM_NetworkLevel(:,neti,step:step+30-1))',squeeze(RestDay1_WM_NetworkLevel(:,netj,step:step+30-1))');
        end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/dISFC_RestDay1.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/dISFC_RestDay1.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/dISFC_subpair_RestDay1','dISFC_subpair_RestDay1');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/dISFC_RestDay1','dISFC_RestDay1');
