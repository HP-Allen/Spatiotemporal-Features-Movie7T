...
load('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/dISFC_subpair_MovieDay2','dISFC_subpair_MovieDay2');
load('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/dISFC_MovieDay2','dISFC_MovieDay2');

[subn,~,netn,netm] = size(dISFC_subpair_MovieDay2);
itern = 5000;
num = 171*(1+171)/2;
...
save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/dynamic_median_SWB_Day2_diag','dynamic_median_SWB_Day2_diag');

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 

clear;

load('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/sISFC_subpair_MovieDay2_r','sISFC_subpair_MovieDay2_r');
load('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/sISFC_MovieDay2_r','sISFC_MovieDay2_r');

[subn,~,netn,netm] = size(sISFC_subpair_MovieDay2_r);
itern = 5000;
num = 171*(1+171)/2;
...
save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/NetworkLevel/static_median_SWB_Day2_diag','static_median_SWB_Day2_diag');
