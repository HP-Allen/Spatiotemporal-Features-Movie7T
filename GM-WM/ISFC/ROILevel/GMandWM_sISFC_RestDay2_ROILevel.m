...
for roii = 1:image_dim(2)
    ...
    for roij = 1:image_dim(2)
        sISFC_subpair_RestDay2_z(:,:,roii,roij) = atanh(corr(squeeze(RestDay2_GM_ROILevel(:,roii,:))',squeeze(RestDay2_WM_ROILevel(:,roij,:))'));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_RestDay2_r.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_RestDay2_r.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_subpair_RestDay2_r','sISFC_subpair_RestDay2_r');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_RestDay2_r','sISFC_RestDay2_r');
