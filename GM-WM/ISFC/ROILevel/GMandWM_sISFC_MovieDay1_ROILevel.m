...
for roii = 1:image_dim(2)
    ...
    for roij = 1:image_dim(2)
        sISFC_subpair_MovieDay1_z(:,:,roii,roij) = atanh(corr(squeeze(MovieDay1_GM_ROILevel(:,roii,:))',squeeze(MovieDay1_WM_ROILevel(:,roij,:))'));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_MovieDay1_r.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_MovieDay1_r.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_subpair_MovieDay1_r','sISFC_subpair_MovieDay1_r');
save('/home/brain/HuPeng_Project/Analysis/GMandWM/ISFC/ROILevel/sISFC_MovieDay1_r','sISFC_MovieDay1_r');
