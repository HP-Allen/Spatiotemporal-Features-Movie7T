...
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/ISFC/ROILevel/ICC_sISFC_Rest_GMandWM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/ISFC/ROILevel/ICC_sISFC_Movie_GMandWM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/ISFC/ROILevel/ICC_dISFC_Rest_GMandWM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/ISFC/ROILevel/ICC_dISFC_Movie_GMandWM');
