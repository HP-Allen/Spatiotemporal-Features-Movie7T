...
open('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Movie_FC.fig')

text(-0.7,0.15,'r=-0.7286 p<0.0001','FontName','Times New Roman','FontWeight','bold');
xlabel('sFC');
ylabel('dFC');
set(gca,'FontName','Times New Roman','FontWeight','bold');

saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Movie_FC.fig');
...
open('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Rest_FC.fig')

text(-0.6,0.15,'r=-0.6749 p<0.0001','FontName','Times New Roman','FontWeight','bold');
xlabel('sFC');
ylabel('dFC');
set(gca,'FontName','Times New Roman','FontWeight','bold');

saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Rest_FC.fig');
...
open('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Movie_ISFC.fig');

text(-0.5,0.25,'r=-0.1603 p<0.0001','FontName','Times New Roman','FontWeight','bold');
xlabel('sISFC');
ylabel('dISFC');
set(gca,'FontName','Times New Roman','FontWeight','bold');

saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Movie_ISFC.fig');
...
open('/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Rest_ISFC.fig');

text(-0.35,0.57,'r=0 p=0.4139','FontName','Times New Roman','FontWeight','bold');
xlabel('sISFC');
ylabel('dISFC');
set(gca,'FontName','Times New Roman','FontWeight','bold');

saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM-WM/Heatmap/Rest_ISFC.fig');
