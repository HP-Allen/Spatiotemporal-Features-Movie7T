...
for roii = 1:image_dim(2)
    ...
    for roij = 1:image_dim(2)
        ...
        for step = 1:image_dim(3)-30+1
        	dISFC_series(:,:,step) = corr(squeeze(MovieDay2_WM_ROILevel(:,roii,step:step+30-1))',squeeze(MovieDay2_WM_ROILevel(:,roij,step:step+30-1))');
        end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/dISFC_MovieDay2.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/dISFC_MovieDay2.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/dISFC_subpair_MovieDay2','dISFC_subpair_MovieDay2');
save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/dISFC_MovieDay2','dISFC_MovieDay2');
