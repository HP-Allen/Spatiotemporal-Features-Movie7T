...
for roii = 1:image_dim(2)
    ...
    for roij = 1:image_dim(2)
        sISFC_subpair_RestDay1_z(:,:,roii,roij) = atanh(corr(squeeze(RestDay1_WM_ROILevel(:,roii,:))',squeeze(RestDay1_WM_ROILevel(:,roij,:))'));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_RestDay1_r.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_RestDay1_r.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_subpair_RestDay1_r','sISFC_subpair_RestDay1_r');
save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_RestDay1_r','sISFC_RestDay1_r');
