...
for roii = 1:image_dim(2)
    ...
    for roij = 1:image_dim(2)
        sISFC_subpair_MovieDay2_z(:,:,roii,roij) = atanh(corr(squeeze(MovieDay2_WM_ROILevel(:,roii,:))',squeeze(MovieDay2_WM_ROILevel(:,roij,:))'));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_MovieDay2_r.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_MovieDay2_r.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_subpair_MovieDay2_r','sISFC_subpair_MovieDay2_r');
save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/ROILevel/sISFC_MovieDay2_r','sISFC_MovieDay2_r');
