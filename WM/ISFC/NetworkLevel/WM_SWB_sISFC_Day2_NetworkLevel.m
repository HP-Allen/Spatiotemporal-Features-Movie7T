...
load('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dISFC_subpair_MovieDay2','dISFC_subpair_MovieDay2');
load('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dISFC_MovieDay2','dISFC_MovieDay2');

[subn,~,netn,~] = size(dISFC_subpair_MovieDay2);
itern = 5000;
num = 171*(1+171)/2;
...
% end
% 
% save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dynamic_mean_SWB','dynamic_mean_SWB');
...
for neti = 1:netn
   for netj = 1:neti
      ...
      dynamic_median_SWB_Day2_diag(neti,netj) = (length(find(abs(randmedianvalue(neti,netj,:)) > abs(medianvalue)))+1) / (itern+1);
   end
    
end

save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dynamic_median_SWB_Day2_diag','dynamic_median_SWB_Day2_diag');

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 

clear;

load('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/sISFC_subpair_MovieDay2_r','sISFC_subpair_MovieDay2_r');
load('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/sISFC_MovieDay2_r','sISFC_MovieDay2_r');

[subn,~,netn,~] = size(sISFC_subpair_MovieDay2_r);
itern = 5000;
num = 171*(1+171)/2;
...
% end
% 
% save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/static_mean_SWB','static_mean_SWB');
...
for neti = 1:netn
   for netj = 1:neti
      ...
      static_median_SWB_Day2_diag(neti,netj) = (length(find(abs(randmedianvalue(neti,netj,:)) > abs(medianvalue)))+1) / (itern+1);
   end
    
end

save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/static_median_SWB_Day2_diag','static_median_SWB_Day2_diag');
