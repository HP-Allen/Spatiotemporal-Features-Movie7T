...
for neti = 1:image_dim(2)
    ...
    for netj = 1:image_dim(2)
        ...
        for step = 1:image_dim(3)-30+1
        	dISFC_series(:,:,neti,netj,step) = corr(squeeze(RestDay2_WM_NetworkLevel(:,neti,step:step+30-1))',squeeze(RestDay2_WM_NetworkLevel(:,netj,step:step+30-1))');
        end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dISFC_RestDay2.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dISFC_RestDay2.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dISFC_subpair_RestDay2','dISFC_subpair_RestDay2');
save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/dISFC_RestDay2','dISFC_RestDay2');
