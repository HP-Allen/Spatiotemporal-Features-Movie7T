...
for neti = 1:image_dim(2)
    ...
    for netj = 1:image_dim(2)
        sISFC_subpair_RestDay1_z(:,:,neti,netj) = atanh(corr(squeeze(RestDay1_WM_NetworkLevel(:,neti,:))',squeeze(RestDay1_WM_NetworkLevel(:,netj,:))'));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/sISFC_RestDay1_r.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/sISFC_RestDay1_r.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/sISFC_subpair_RestDay1_r','sISFC_subpair_RestDay1_r');
save('/home/brain/HuPeng_Project/Analysis/WM/ISFC/NetworkLevel/sISFC_RestDay1_r','sISFC_RestDay1_r');