...
for subi = 1:image_dim(1)
    ...
    sFC_MovieDay2(subi,:,:) = corr(squeeze(MovieDay2_WM_ROILevel(subi,:,:))',squeeze(MovieDay2_WM_ROILevel(subi,:,:))');
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_MovieDay2_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_MovieDay2_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_MovieDay2','sFC_MovieDay2');
save('/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_MovieDay2_ave','sFC_MovieDay2_ave');
