...
for subi = 1:image_dim(1)
    ...
    sFC_RestDay2(subi,:,:) = corr(squeeze(RestDay2_WM_ROILevel(subi,:,:))',squeeze(RestDay2_WM_ROILevel(subi,:,:))');
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_RestDay2_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_RestDay2_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_RestDay2','sFC_RestDay2');
save('/home/brain/HuPeng_Project/Analysis/WM/FC/ROILevel/sFC_RestDay2_ave','sFC_RestDay2_ave');
