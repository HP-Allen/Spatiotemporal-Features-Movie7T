...
maskname = "/home/brain/HuPeng_Project/Mask/GMmask_allsubjs_rmHO_Buckner_manual2.nii"
...
for idx, in_file in enumerate(infiles):
    ...
    outname = '/home/brain/HuPeng_Project/Analysis/GM/Parcellation/step1/rm_tcorr_conn_' + str(idx) + '.npy'
...
for idx, in_file in enumerate(infiles):
    # construct filenames
    infile = '/home/brain/HuPeng_Project/Analysis/GM/Parcellation/step1/rm_tcorr_conn_' + str(idx) + '.npy'
    outfile = '/home/brain/HuPeng_Project/Analysis/GM/Parcellation/step2/rm_tcorr_indiv_cluster_' + str(idx)
...
for k in NUM_CLUSTERS:
    ...
    for i in range(0, len(infiles)):
        ind_clust_files.append(
            '/home/brain/HuPeng_Project/Analysis/GM/Parcellation/step2/rm_tcorr_indiv_cluster_' + str(i) + \
            '_' + str(k) + '.npy')

    print '2-level parcellate tcorr', k
    group_binfile_parcellate(ind_clust_files,
                             '/home/brain/HuPeng_Project/Analysis/GM/Parcellation/step3/rm_group_tcorr_cluster_' + str(
                                 k) + '.npy', k, mask_voxels)
...
for k in NUM_CLUSTERS:
    binfile = '/home/brain/HuPeng_Project/Analysis/GM/Parcellation/step3/rm_group_tcorr_cluster_' + str(k) + '.npy'
    imgfile = '/home/brain/HuPeng_Project/Analysis/GM/Parcellation/step4/rm_group_tcorr_cluster_' + str(k) + '.nii'
