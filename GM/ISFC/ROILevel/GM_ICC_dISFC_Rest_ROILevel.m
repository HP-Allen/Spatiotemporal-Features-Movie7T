...
load('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/dISFC_subpair_RestDay1');
load('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/dISFC_subpair_RestDay2');
...
for roii = 1:dim(3)
    for roij = 1:roii
        ...
        a = reshape(dISFC_subpair_RestDay1(:,:,roii,roij),dim(1)*dim(2),1);
        b = reshape(dISFC_subpair_RestDay2(:,:,roii,roij),dim(1)*dim(2),1);
        a(tmp==1) = []; b(tmp==1) = [];
        M = [a,b];
        [r, LB, UB, F, df1, df2, p] = ICC(M, type);
        ICC_dISFC_Rest_GM(roii,roij) = r;
    end
end

ICC_dISFC_Rest_GM = ICC_dISFC_Rest_GM+transpose(tril(ICC_dISFC_Rest_GM,-1));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_dISFC_Rest_GM.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_dISFC_Rest_GM.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_dISFC_Rest_GM','ICC_dISFC_Rest_GM');
