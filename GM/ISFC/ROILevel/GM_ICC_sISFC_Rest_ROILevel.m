...
load('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/sISFC_subpair_RestDay1_r');
load('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/sISFC_subpair_RestDay2_r');
...
for roii = 1:dim(3)
    for roij = 1:roii
        ...
        a = reshape(sISFC_subpair_RestDay1_r(:,:,roii,roij),dim(1)*dim(2),1);
        b = reshape(sISFC_subpair_RestDay2_r(:,:,roii,roij),dim(1)*dim(2),1);
        a(tmp==1) = []; b(tmp==1) = [];
        M = [a,b];
        [r, LB, UB, F, df1, df2, p] = ICC(M, type);
        ICC_sISFC_Rest_GM(roii,roij) = r;
    end
end

ICC_sISFC_Rest_GM = ICC_sISFC_Rest_GM+transpose(tril(ICC_sISFC_Rest_GM,-1));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_sISFC_Rest_GM.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_sISFC_Rest_GM.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_sISFC_Rest_GM','ICC_sISFC_Rest_GM');
