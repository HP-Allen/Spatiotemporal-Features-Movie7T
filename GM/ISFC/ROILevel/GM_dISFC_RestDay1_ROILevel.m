...
for roii = 1:image_dim(2)
    ...
    for roij = 1:image_dim(2)
        ...
        for step = 1:image_dim(3)-30+1
        	dISFC_series(:,:,step) = corr(squeeze(RestDay1_GM_ROILevel(:,roii,step:step+30-1))',squeeze(RestDay1_GM_ROILevel(:,roij,step:step+30-1))');
        end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/dISFC_RestDay1.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/dISFC_RestDay1.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/dISFC_subpair_RestDay1','dISFC_subpair_RestDay1');
save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/dISFC_RestDay1','dISFC_RestDay1');
