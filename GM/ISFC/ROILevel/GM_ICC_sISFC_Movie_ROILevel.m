...
load('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/sISFC_subpair_MovieDay1_r');
load('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/sISFC_subpair_MovieDay2_r');
...
for roii = 1:dim(3)
    for roij = 1:roii
        ...
        a = reshape(sISFC_subpair_MovieDay1_r(:,:,roii,roij),dim(1)*dim(2),1);
        b = reshape(sISFC_subpair_MovieDay2_r(:,:,roii,roij),dim(1)*dim(2),1);
        a(tmp==1) = []; b(tmp==1) = [];
        M = [a,b];
        [r, LB, UB, F, df1, df2, p] = ICC(M, type);
        ICC_sISFC_Movie_GM(roii,roij) = r;
    end
end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_sISFC_Movie_GM.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_sISFC_Movie_GM.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/ROILevel/ICC_sISFC_Movie_GM','ICC_sISFC_Movie_GM');
