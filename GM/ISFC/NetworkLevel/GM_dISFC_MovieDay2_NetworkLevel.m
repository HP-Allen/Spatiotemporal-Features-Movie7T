...
for neti = 1:image_dim(2)
    ...
    for netj = 1:image_dim(2)
        ...
        for step = 1:image_dim(3)-30+1
        	dISFC_series(:,:,neti,netj,step) = corr(squeeze(MovieDay2_GM_NetworkLevel(:,neti,step:step+30-1))',squeeze(MovieDay2_GM_NetworkLevel(:,netj,step:step+30-1))');
        end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/dISFC_MovieDay2.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/dISFC_MovieDay2.fig');
close all;
...
% end
% 
% save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/dynamic_p_SWB','dynamic_p_SWB');
% 
% 
...
save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/dISFC_subpair_MovieDay2','dISFC_subpair_MovieDay2');
save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/dISFC_MovieDay2','dISFC_MovieDay2');
