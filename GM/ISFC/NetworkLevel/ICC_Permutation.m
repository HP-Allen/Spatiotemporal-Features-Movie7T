...
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/ISFC/NetworkLevel/ICC_sISFC_Rest_GM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/ISFC/NetworkLevel/ICC_sISFC_Movie_GM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/ISFC/NetworkLevel/ICC_dISFC_Rest_GM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/ISFC/NetworkLevel/ICC_dISFC_Movie_GM');
