...
for neti = 1:image_dim(2)
    ...
    for netj = 1:image_dim(2)
        sISFC_subpair_MovieDay2_z(:,:,neti,netj) = atanh(corr(squeeze(MovieDay2_GM_NetworkLevel(:,neti,:))',squeeze(MovieDay2_GM_NetworkLevel(:,netj,:))'));
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/sISFC_MovieDay2_r.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/sISFC_MovieDay2_r.fig');
close all;
...
% end
% 
% save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/static_p_SWB','static_p_SWB');
% 
% 
...
% end
% 
% save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/static_p_EWB','static_p_EWB');
% 
...
% end
% 
% save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/static_p_EWP','static_p_EWP');
% 
% 
...
% end
% 
% save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/static_p_SWP','static_p_SWP');


save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/sISFC_subpair_MovieDay2_r','sISFC_subpair_MovieDay2_r');
save('/home/brain/HuPeng_Project/Analysis/GM/ISFC/NetworkLevel/sISFC_MovieDay2_r','sISFC_MovieDay2_r');