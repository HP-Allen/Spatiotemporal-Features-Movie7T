...
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/NetworkLevel/ICC_sFC_Rest_GM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/NetworkLevel/ICC_sFC_Movie_GM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/NetworkLevel/ICC_dFC_Rest_GM');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/NetworkLevel/ICC_dFC_Movie_GM');
