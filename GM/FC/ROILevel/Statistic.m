...
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/sFC_MovieDay1','sFC_MovieDay1');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/sFC_RestDay1','sFC_RestDay1');
...
saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/sFC_pairT.png');
saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/sFC_pairT.fig');
close;
...
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/dFC_MovieDay1','dFC_MovieDay1');
load('/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/dFC_RestDay1','dFC_RestDay1');
...
saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/dFC_pairT.png');
saveas(gcf,'/media/brain/data/HuPeng_Project/Movie/Analysis/GM/FC/ROILevel/dFC_pairT.fig');
close;
