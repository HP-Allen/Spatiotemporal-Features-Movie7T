...
% FC
load('/home/brain/HuPeng_Project/Analysis/GM/Timeseries/ROILevel/RestDay1_GM_ROILevel');
...
for subi = 1:image_dim(1)
    ...
    for step = 1:image_dim(3)-30+1
        dFC_series(subi,:,:,step) = corr(squeeze(RestDay1_GM_ROILevel(subi,:,step:step+30-1))', squeeze(RestDay1_GM_ROILevel(subi,:,step:step+30-1))');
    end
...
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/FC/ROILevel/dFC_RestDay1_ave.png');
saveas(gcf,'/home/brain/HuPeng_Project/Analysis/GM/FC/ROILevel/dFC_RestDay1_ave.fig');
close all;

save('/home/brain/HuPeng_Project/Analysis/GM/FC/ROILevel/dFC_RestDay1','dFC_RestDay1');
save('/home/brain/HuPeng_Project/Analysis/GM/FC/ROILevel/dFC_RestDay1_ave','dFC_RestDay1_ave');
